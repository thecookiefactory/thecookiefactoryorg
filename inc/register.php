...
<input class='account-input' pattern='\w{2,10}' type='text' placeholder='username' name='username' required='required' autocomplete='off' oninput='checkInputBox(this)' oninvalid='this.setCustomValidity(\"Must be 2-10 alphanumeric characters.\")' autofocus><span class='account-text'>, and you will know it really is me when I tell you my secret password, which is </span>
<input class='account-input' pattern='.{6,30}' type='password' placeholder='password' name='password' required='required' autocomplete='off' oninput='checkInputBox(this)' oninvalid='this.setCustomValidity(\"Must be 6-30 characters.\")'><span class='account-text'>. Should you ever want to contact me, feel free to do so at my email address, </span>
<input class='account-input' type='email' placeholder='email' name='email' required='required' autocomplete='off' oninput='checkInputBox(this)' oninvalid='this.setCustomValidity(\"Must be a valid email address.\")'>
